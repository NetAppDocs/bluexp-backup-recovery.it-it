...
La documentazione per ciascuna API di backup e ripristino BlueXP è disponibile all'interno del sito https://docs.netapp.com/us-en/cloud-manager-automation/cbs/overview.html[].
