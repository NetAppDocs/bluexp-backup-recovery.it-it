...
Le copie di backup sono associate a  https://docs.netapp.com/us-en/bluexp-setup-admin/concept-netapp-accounts.html["Account BlueXP"^] in cui risiede il connettore BlueXP .

Se nello stesso account BlueXP sono presenti più connettori, ogni connettore visualizza lo stesso elenco di backup.
