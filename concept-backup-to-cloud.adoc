...
[role="lead"]
Il servizio BlueXP backup and recovery fornisce una protezione dei dati efficiente, sicura e conveniente per volumi ONTAP , istanze e database Microsoft SQL Server, carichi di lavoro VMware e carichi di lavoro Kubernetes (anteprima).
