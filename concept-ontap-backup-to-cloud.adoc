...
* link:concept-cloud-backup-policies.html#datalock-and-ransomware-protection["Funzionamento di DataLock e protezione ransomware"].
* link:manage-backup-settings-ontap.html["Come aggiornare le opzioni di protezione dal ransomware nella pagina Impostazioni avanzate"].
