...
Puoi creare policy di backup, replica e backup su storage a oggetti nell'interfaccia utente di backup e recovery di BlueXP . Per ulteriori informazioni, vedere la sezione link:task-manage-backups-ontap.html#add-a-new-backup-to-cloud-policy["aggiunta di un nuovo criterio di backup"].
...
* Puoi effettuare il backup dei dati dai sistemi ONTAP on-premise o dai sistemi Cloud Volumes ONTAP installati nelle aree commerciali AWS su Amazon S3. link:task-backup-to-s3.html["Eseguire il backup dei dati Cloud Volumes ONTAP su Amazon S3"].
...
* Puoi effettuare il backup dei dati dai sistemi ONTAP on-premise o dai sistemi Cloud Volumes ONTAP installati nelle aree commerciali di Azure in Azure Blob. link:task-backup-to-azure.html["Eseguire il backup dei dati Cloud Volumes ONTAP in Azure Blob"].
