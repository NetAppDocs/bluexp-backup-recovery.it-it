...
----
+
Mentre l'indirizzo IP, il nome utente e le password sono valori personalizzati, il nome account non lo è. Il nome dell'account è sempre "account-DARKSITE1".
