...
Questi passaggi sono necessari solo quando si è https://docs.netapp.com/us-en/cloud-manager-backup-restore/task-backup-to-azure.html["Backup dei dati Cloud Volumes ONTAP nello storage Azure Blob"^].
