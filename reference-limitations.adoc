...
* Il backup e recovery di BlueXP  non effettua il backup dei volumi su storage a oggetti con NetApp Volume Encryption (NVE) abilitato e NetApp aggregate Encryption (NAE) abilitato in ONTAP.
+
