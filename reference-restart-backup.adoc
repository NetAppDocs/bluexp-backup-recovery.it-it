...
| Implementazione del cloud | Seguire le istruzioni per https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-managing-connectors.html#connect-to-the-linux-vm["Connessione alla macchina virtuale Connector Linux"^] a seconda del cloud provider utilizzato. 
