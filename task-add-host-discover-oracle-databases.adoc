...
** Installare il plug-in utilizzando lo script e aggiungere l'host dall'interfaccia utente utilizzando l'opzione manuale. <<Aggiungere host dall'interfaccia utente utilizzando l'opzione manuale e installare il plug-in utilizzando lo script,Scopri di più>>.


* Se SSH è disattivato, installare il plug-in manualmente e aggiungere l'host dall'interfaccia utente utilizzando l'opzione manuale. <<Aggiungere host dall'interfaccia utente utilizzando l'opzione manuale e installare il plug-in manualmente,Scopri di più>>.
