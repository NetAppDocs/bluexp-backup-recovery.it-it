...
Scegliere se connettere il cluster ONTAP on-premise direttamente ad Azure tramite Internet pubblico o se utilizzare una VPN o Azure ExpressRoute e instradare il traffico attraverso un'interfaccia endpoint VPC privata ad Azure.
