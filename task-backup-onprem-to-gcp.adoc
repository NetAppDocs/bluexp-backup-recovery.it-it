...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["Tre"] Preparare il collegamento in rete per il connettore
[role="quick-margin-para"]
Assicurarsi che il connettore disponga delle connessioni di rete richieste.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Quattro"] Verificare i requisiti di licenza
[role="quick-margin-para"]
È necessario verificare i requisiti di licenza per Google Cloud e BlueXP.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinque"] Prepara i tuoi cluster ONTAP
[role="quick-margin-para"]
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png["Sei"] Preparare Google Cloud come destinazione di backup
[role="quick-margin-para"]
...
In alternativa, è possibile impostare chiavi personalizzate per la crittografia dei dati invece di utilizzare le chiavi di crittografia predefinite di Google Cloud.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-7.png["Sette"] Attivare i backup sui ONTAP Volumes
[role="quick-margin-para"]
