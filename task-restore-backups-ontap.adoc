...
Il catalogo indicizzato v2, rilasciato a febbraio 2025, presenta nuove funzionalità che lo rendono più efficiente e facile da utilizzare. Questa versione ha un significativo miglioramento delle prestazioni ed è abilitata per impostazione predefinita per tutti i nuovi clienti.
