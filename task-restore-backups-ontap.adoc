...
+
Facoltativamente, cercare tag personalizzati per elencare solo i volumi con un tag specifico.

+
image:screenshot_restore_select_volume_snapshot2.png["Una schermata che mostra la selezione dell'ambiente di lavoro, del volume e del file di backup del volume che si desidera ripristinare."]
