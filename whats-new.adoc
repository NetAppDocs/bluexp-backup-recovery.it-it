...
=== 3-2-1 creazione di criteri durante l'attivazione del backup

In precedenza, era necessario creare criteri personalizzati prima di avviare una snapshot, una replica o un backup. A partire da ONTAP 9,8 P5, ora puoi creare una policy durante il processo di attivazione del backup utilizzando l'interfaccia utente di backup e recovery di BlueXP.
...
=== Supporto del ripristino rapido on-demand
...
Il monitoraggio dei processi di backup e ripristino di BlueXP visualizza ora informazioni sui processi di ripristino rapido.
